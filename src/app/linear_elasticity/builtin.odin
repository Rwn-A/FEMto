...
constant_material :: proc(tbl: ^cfg.Table) -> (mat: Material_Int, ok: bool) {
    Schema :: struct {
        ...
        poissons_ratio:  f64 `validate:"required,gt=0,lt=0.5"`,
    ...
    mat.data = data
    mat.procedure = proc(mapped: fem.Mapped_Element, time: f64, current_strain: []fem.Voigt6, data: rawptr, out: Material) {
